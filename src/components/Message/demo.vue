<template>
  <div class="demo-block">
    ...
    <div class="demo-row" @click.stop="handleClick()">
      <span class="demo-row_subtitle">基本用法</span>
    ...
    <div class="demo-row">
      <span class="demo-row_subtitle">不同状态</span>
    ...
    <div class="demo-row">
      <span class="demo-row_subtitle">使用 HTML 片段</span>
    ...
    <div class="demo-row">
      <span class="demo-row_subtitle">自定义垂直偏移量</span>
